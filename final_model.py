...
# cleans the data set to remove all NA values
clean_ab = (
    atbat_df
...
# Pulls the tunneling score from the random intercepts
...
# Takes the z-score of each mixed effects model tunneling score
...
# Compute correlation between two model types
...
# Correlation between outs and each mode type
